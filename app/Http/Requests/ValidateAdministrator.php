...
class ValidateAdministrator extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'occupation_id' => ['required', 'exists:App\Occupation,id'],
    ...
    public function messages()
    {
        return [
            ...
            'occupation_id.required' => 'Please provide an occupation.',
            'occupation_id.exists' => 'Occupation provided is not available.',
