    ...
    <div id="root">
        <div class="container bg-white mx-auto px-0 shadow-sm">
            ...
            <div class="container pt-5">
                ...
                Owner.
                <hr class="my-2" />
                <h2>Owners and Data Controllers</h2>
                <div class="p-2">
                    <b class="name">John Michael Manlupig</b>
                    <p class="mb-0">
                        Lico-an, Barotac Nuevo, Iloilo, Philippines
                    </p>
                    <p class="mt-0 pt-0">manlupigjohnmichael@gmail.com</p>
                </div>
                ...
                <hr class="mt-3 mb-5" />
                <h2 class="mb-2">Mode and place of processing the Data</h2>
                ...
                <p>
                    ...
                    Owner to safeguard their Data.<br /><br />
                ...
                <div class="pb-2">
                    ...
                    <p>
                        ...
                        Application or the related Services.<br />The User
                    ...
                    <p>
                        ...
                        requests.<br />To determine whether any of the
                    ...
                    <p>
                        ...
                        <br /><br />Should the changes affect processing
                        activities performed on the basis of the User’s consent,
                        the Owner shall collect new consent from the User, where
                        required.
                    </p>
                </div>
